...
func (e *BoolError) Error() string {
	if *e {
		return "чето случилось"
	}
	return "намана живчик"
}

func (e *BoolError) Bool() bool {
	return bool(*e)
}

func (e *BoolError) BoolButCool() string {
	if *e {
		return "<< TRUE ))))))) >>"
	}
	return "<< FALSE ((((((( >>"
...
func (e *BoolError) Negative() *BoolError {
	*e = !*e
	return e
}

func (e *BoolError) Secret() {
	fmt.Println(`1
...
func NewError() BoolError {
	return BoolError(true)
}

func NoError() BoolError {
